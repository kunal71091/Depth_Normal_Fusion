...
namespace D3D_CUDA
{
    namespace CudaFishEyeImageProcessorDeviceCode
    {
        ...
        {
            // bind texture
            D3D_CUDA_CHECKED_CALL( cudaBindTexture2D(0, fishEyeImageProcessorGrayscaleTexture, inputImg.getAddr(), fishEyeImageProcessorGrayscaleChannelDesc, inputImg.getWidth(), inputImg.getHeight(), inputImg.getPitch()); )
            ...
            D3D_CUDA_CHECKED_CALL( cudaUnbindTexture(fishEyeImageProcessorGrayscaleTexture); )
