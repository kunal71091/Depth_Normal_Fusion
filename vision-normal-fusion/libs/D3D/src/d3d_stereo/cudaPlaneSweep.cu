    ...
    namespace CudaPlaneSweepDeviceCode
    {
                              ...
                              DeviceBuffer<float>& costBuf)
        {
            ...
            if (color)
            {
                ...
                D3D_CUDA_CHECKED_CALL( cudaBindTexture2D(0, planeSweepColorTexture, srcImg.getAddr(), planeSweepColorChannelDesc, srcImg.getWidth(), srcImg.getHeight(), srcImg.getPitch()); )
                ...
                D3D_CUDA_CHECKED_CALL( cudaUnbindTexture(planeSweepColorTexture); )
            }
            else
            {
